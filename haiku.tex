\title{Haiku\\OS Report Part I}
\author{Troy Hildebrandt -- 100xxxxxx\\Nima Hoda -- 100308135\\ \\COMP 3000}
\date{\today}
...
commits over many years (HaikuContrib).  The source code is revision
controlled by an SVN repository and managed by Trac
...
\end{itemize}
Any of the image formats may be used live, to try Haiku without the
need for installation, or to install Haiku to another disk volume
...
\$10 per disc \cite{HaikuIncOrder}.  Source code for this release is also
available for download in compressed archived form
\cite{HaikuR1A3Src}.
